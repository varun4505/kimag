...
const Hero: React.FC = () => {
  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-8 sm:pt-12 lg:pt-4">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-center min-h-[80vh]">
          ...
          <div className="text-center lg:text-left space-y-6 lg:space-y-8 flex flex-col justify-center">
            ...
            <div className="lg:hidden relative w-full h-80 flex items-center justify-center my-8">
              ...
              >
                ...
                {[
                  { name: "Media", icon: "🗞️", angle: 0 },
                  { name: "Crisis", icon: "⚠️", angle: 90 },
                  { name: "Digital", icon: "💻", angle: 180 },
                  { name: "Events", icon: "🎯", angle: 270 }
                ].map((item, index) => {
                  const radius = 100;
                  ...
                  return (
                    ...
                    >
                      <div className="w-8 h-8 bg-white/95 backdrop-blur-sm rounded-full shadow-lg border border-gray-200/50 flex items-center justify-center text-sm">
                        {item.icon}
                      </div>
                    </motion.div>
                  );
